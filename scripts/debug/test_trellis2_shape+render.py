...
def main():
    ...
    save_normal_image(ref_normal, ref_mask, f"{args.save_dir}/normal_ref.png")
    save_normal_image(our_normal, our_mask, f"{args.save_dir}/normal_our.png")
