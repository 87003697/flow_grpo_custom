#!/bin/bash
# TRELLIS Stage 2 FlowEdit Denoise + 三图 DINO GAN 训练脚本
#
# 训练流程：
...
#   → 2D FlowEdit Guidance (三图 GAN: BCE + BT) → loss → autograd backward
...
echo "========================================"
echo "GPU 分配信息（FlowEdit Denoise + 三图 GAN）"
echo "========================================"
...
python -m accelerate.commands.launch \
  ...
  --config=config/trellis_stage2_flowedit_denoise_triimage_gan.py \
