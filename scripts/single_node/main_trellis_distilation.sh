...
# RUN_NAME="trellis_x0-1_FlowEdit-full_steps-20-40_cfg-12_sgd_lr-1e-3"

# export CUDA_VISIBLE_DEVICES=2,3
# RUN_NAME="trellis_x0-01_FlowEdit-full_steps-20-40_cfg-12_sgd_lr-1e-3"

# export CUDA_VISIBLE_DEVICES=4,5
# RUN_NAME="trellis_x0-001_FlowEdit-full_steps-20-40_cfg-12_sgd_lr-1e-3"

# export CUDA_VISIBLE_DEVICES=6,7
# RUN_NAME="trellis_v-01_FlowEdit-full_steps-20-40_cfg-12_sgd_lr-1e-3"
