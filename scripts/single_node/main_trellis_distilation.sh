...
# RUN_NAME="trellis_kl-uni-1_CSD-uni_lr-3e-8"

# export CUDA_VISIBLE_DEVICES=2,3
# RUN_NAME="trellis_kl-uni-1_CSD-uni_lr-3e-5"

# export CUDA_VISIBLE_DEVICES=4,5
# RUN_NAME="trellis_kl-uni-1_CSD-ada1_lr-3e-5"

# export CUDA_VISIBLE_DEVICES=6,7
# RUN_NAME="trellis_kl-uni-1_CSD-ada01_lr-3e-5"
