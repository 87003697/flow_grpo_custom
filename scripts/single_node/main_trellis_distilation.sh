...
# RUN_NAME="trellis-full_kl-uni-0_Contrast-12-cond_ada1e-4_sgd_lr-1e-3"

# export CUDA_VISIBLE_DEVICES=2,3
# RUN_NAME="trellis-full_kl-uni-0_Contrast-12-cond_ada1e-4_sgd_lr-3e-3"

export CUDA_VISIBLE_DEVICES=4,5
RUN_NAME="trellis-full_kl-uni-0_Contrast-12-cond_ada1e-4_sgd_lr-5e-3"

# export CUDA_VISIBLE_DEVICES=6,7
# RUN_NAME="trellis-full_kl-uni-0_Contrast-12-cond_ada1e-4_sgd_lr-5e-4"
