...
# RUN_NAME="trellis-full_kl-uni-0_Contrast-fixed_ada1e-4_lr-3e-4_eps-1e-4_acc"

# export CUDA_VISIBLE_DEVICES=2,3
# RUN_NAME="trellis-full_kl-uni-0_Contrast-uncond_ada1e-4_lr-3e-4_eps-1e-4_acc"

# export CUDA_VISIBLE_DEVICES=4,5
# RUN_NAME="trellis-full_kl-uni-0_Contrast-cond_ada1e-4_lr-3e-4_eps-1e-4_acc"

export CUDA_VISIBLE_DEVICES=6,7
RUN_NAME="trellis-full_kl-uni-0_Contrast-cfg_ada1e-4_lr-3e-4_eps-1e-4_acc"
