#!/bin/bash
# 单机 Direct3D‑S2 GRPO (sparse512) 最小启动脚本
set -euo pipefail
...
LOG_DIR=${LOG_DIR:-logs/direct3d_s2_grpo_single}
RUN_NAME=${RUN_NAME:-direct3d_s2_grpo}
...
echo "[Direct3D-S2] CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES RUN_NAME=$RUN_NAME" 
...
echo "✅ Direct3D‑S2 minimal training skeleton started. Logs: ${LOG_DIR}" 
