...
#
# 使用示例：
#   RUN_NAME=distill_ganonly_w001 bash scripts/multi_node/main_trellis_distillation_latent_gan_cfgdiff.sh
...
echo "========================================"
echo "Distillation + CFG-Diff Latent GAN (Autograd VJP)"
echo "========================================"
...
python -m accelerate.commands.launch \
  ...
  --config=config/trellis_stage2_distillation_latent_gan_cfgdiff.py \
