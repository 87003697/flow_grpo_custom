#!/bin/bash
# TRELLIS Stage 2 FlowEdit + CFG-Diff Latent GAN 训练脚本
...
echo "========================================"
echo "GPU 分配信息（FlowEdit + CFG-Diff Latent GAN — Autograd）"
echo "========================================"
...
python -m accelerate.commands.launch \
  ...
  --config=config/trellis_stage2_flowedit_latent_gan_cfgdiff.py \
