...
与 BCE 版本的区别：D loss 用 Bradley-Terry pairwise ranking。
"""
...
def get_config():
    cfg = _base_config()
    cfg.run_name = "distill_latent_gan_cfgdiff_bt"

    # === Guidance: 切换到 CFG-Diff Latent GAN (BT) ===
    g = cfg.guidance
    g.type = "flowedit_latent_gan_cfgdiff_bt"
    g.flowedit_latent_gan_cfgdiff_bt = ml_collections.ConfigDict(g.flowedit.to_dict())
